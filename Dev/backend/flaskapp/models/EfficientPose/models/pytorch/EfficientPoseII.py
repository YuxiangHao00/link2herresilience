...
class KitModel(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.stem_conv_res1_convolution = self.__conv(2, name='stem_conv_res1/convolution', in_channels=3, out_channels=48, kernel_size=(3, 3), stride=(2, 2), groups=1, bias=None)
        ...
        self.stem_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'stem_bn_res1/FusedBatchNorm_1', num_features=48, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block1a_dwconv_res1_depthwise = self.__conv(2, name='block1a_dwconv_res1/depthwise', in_channels=48, out_channels=48, kernel_size=(3, 3), stride=(1, 1), groups=48, bias=None)
        ...
        self.block1a_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block1a_bn_res1/FusedBatchNorm_1', num_features=48, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block1a_se_reduce_res1_convolution = self.__conv(2, name='block1a_se_reduce_res1/convolution', in_channels=48, out_channels=12, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        ...
        self.block1a_se_expand_res1_convolution = self.__conv(2, name='block1a_se_expand_res1/convolution', in_channels=12, out_channels=48, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        ...
        self.block1a_project_conv_res1_convolution = self.__conv(2, name='block1a_project_conv_res1/convolution', in_channels=48, out_channels=24, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        ...
        self.block1a_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block1a_project_bn_res1/FusedBatchNorm_1', num_features=24, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block1b_dwconv_res1_depthwise = self.__conv(2, name='block1b_dwconv_res1/depthwise', in_channels=24, out_channels=24, kernel_size=(3, 3), stride=(1, 1), groups=24, bias=None)
        ...
        self.block1b_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block1b_bn_res1/FusedBatchNorm_1', num_features=24, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block1b_se_reduce_res1_convolution = self.__conv(2, name='block1b_se_reduce_res1/convolution', in_channels=24, out_channels=6, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block1b_se_expand_res1_convolution = self.__conv(2, name='block1b_se_expand_res1/convolution', in_channels=6, out_channels=24, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        ...
        self.block1b_project_conv_res1_convolution = self.__conv(2, name='block1b_project_conv_res1/convolution', in_channels=24, out_channels=24, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block1b_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block1b_project_bn_res1/FusedBatchNorm_1', num_features=24, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block2a_expand_conv_res1_convolution = self.__conv(2, name='block2a_expand_conv_res1/convolution', in_channels=24, out_channels=144, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2a_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2a_expand_bn_res1/FusedBatchNorm_1', num_features=144, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block2a_dwconv_res1_depthwise = self.__conv(2, name='block2a_dwconv_res1/depthwise', in_channels=144, out_channels=144, kernel_size=(3, 3), stride=(2, 2), groups=144, bias=None)
        ...
        self.block2a_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2a_bn_res1/FusedBatchNorm_1', num_features=144, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block2a_se_reduce_res1_convolution = self.__conv(2, name='block2a_se_reduce_res1/convolution', in_channels=144, out_channels=6, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2a_se_expand_res1_convolution = self.__conv(2, name='block2a_se_expand_res1/convolution', in_channels=6, out_channels=144, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        ...
        self.block2a_project_conv_res1_convolution = self.__conv(2, name='block2a_project_conv_res1/convolution', in_channels=144, out_channels=32, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        ...
        self.block2a_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2a_project_bn_res1/FusedBatchNorm_1', num_features=32, eps=0.0010000000474974513, momentum=0.0)
        self.block2b_expand_conv_res1_convolution = self.__conv(2, name='block2b_expand_conv_res1/convolution', in_channels=32, out_channels=192, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2b_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2b_expand_bn_res1/FusedBatchNorm_1', num_features=192, eps=0.0010000000474974513, momentum=0.0)
        ...
        self.block2b_dwconv_res1_depthwise = self.__conv(2, name='block2b_dwconv_res1/depthwise', in_channels=192, out_channels=192, kernel_size=(3, 3), stride=(1, 1), groups=192, bias=None)
        self.block2b_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2b_bn_res1/FusedBatchNorm_1', num_features=192, eps=0.0010000000474974513, momentum=0.0)
        self.block2b_se_reduce_res1_convolution = self.__conv(2, name='block2b_se_reduce_res1/convolution', in_channels=192, out_channels=8, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2b_se_expand_res1_convolution = self.__conv(2, name='block2b_se_expand_res1/convolution', in_channels=8, out_channels=192, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2b_project_conv_res1_convolution = self.__conv(2, name='block2b_project_conv_res1/convolution', in_channels=192, out_channels=32, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2b_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2b_project_bn_res1/FusedBatchNorm_1', num_features=32, eps=0.0010000000474974513, momentum=0.0)
        self.block2c_expand_conv_res1_convolution = self.__conv(2, name='block2c_expand_conv_res1/convolution', in_channels=32, out_channels=192, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2c_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2c_expand_bn_res1/FusedBatchNorm_1', num_features=192, eps=0.0010000000474974513, momentum=0.0)
        self.block2c_dwconv_res1_depthwise = self.__conv(2, name='block2c_dwconv_res1/depthwise', in_channels=192, out_channels=192, kernel_size=(3, 3), stride=(1, 1), groups=192, bias=None)
        self.block2c_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2c_bn_res1/FusedBatchNorm_1', num_features=192, eps=0.0010000000474974513, momentum=0.0)
        self.block2c_se_reduce_res1_convolution = self.__conv(2, name='block2c_se_reduce_res1/convolution', in_channels=192, out_channels=8, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2c_se_expand_res1_convolution = self.__conv(2, name='block2c_se_expand_res1/convolution', in_channels=8, out_channels=192, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2c_project_conv_res1_convolution = self.__conv(2, name='block2c_project_conv_res1/convolution', in_channels=192, out_channels=32, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2c_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2c_project_bn_res1/FusedBatchNorm_1', num_features=32, eps=0.0010000000474974513, momentum=0.0)
        self.block2d_expand_conv_res1_convolution = self.__conv(2, name='block2d_expand_conv_res1/convolution', in_channels=32, out_channels=192, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2d_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2d_expand_bn_res1/FusedBatchNorm_1', num_features=192, eps=0.0010000000474974513, momentum=0.0)
        self.block2d_dwconv_res1_depthwise = self.__conv(2, name='block2d_dwconv_res1/depthwise', in_channels=192, out_channels=192, kernel_size=(3, 3), stride=(1, 1), groups=192, bias=None)
        self.block2d_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2d_bn_res1/FusedBatchNorm_1', num_features=192, eps=0.0010000000474974513, momentum=0.0)
        self.block2d_se_reduce_res1_convolution = self.__conv(2, name='block2d_se_reduce_res1/convolution', in_channels=192, out_channels=8, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2d_se_expand_res1_convolution = self.__conv(2, name='block2d_se_expand_res1/convolution', in_channels=8, out_channels=192, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block2d_project_conv_res1_convolution = self.__conv(2, name='block2d_project_conv_res1/convolution', in_channels=192, out_channels=32, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block2d_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block2d_project_bn_res1/FusedBatchNorm_1', num_features=32, eps=0.0010000000474974513, momentum=0.0)
        self.block3a_expand_conv_res1_convolution = self.__conv(2, name='block3a_expand_conv_res1/convolution', in_channels=32, out_channels=192, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3a_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3a_expand_bn_res1/FusedBatchNorm_1', num_features=192, eps=0.0010000000474974513, momentum=0.0)
        self.block3a_dwconv_res1_depthwise = self.__conv(2, name='block3a_dwconv_res1/depthwise', in_channels=192, out_channels=192, kernel_size=(5, 5), stride=(2, 2), groups=192, bias=None)
        self.block3a_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3a_bn_res1/FusedBatchNorm_1', num_features=192, eps=0.0010000000474974513, momentum=0.0)
        self.block3a_se_reduce_res1_convolution = self.__conv(2, name='block3a_se_reduce_res1/convolution', in_channels=192, out_channels=8, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3a_se_expand_res1_convolution = self.__conv(2, name='block3a_se_expand_res1/convolution', in_channels=8, out_channels=192, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3a_project_conv_res1_convolution = self.__conv(2, name='block3a_project_conv_res1/convolution', in_channels=192, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3a_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3a_project_bn_res1/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.block3b_expand_conv_res1_convolution = self.__conv(2, name='block3b_expand_conv_res1/convolution', in_channels=56, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3b_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3b_expand_bn_res1/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.block3b_dwconv_res1_depthwise = self.__conv(2, name='block3b_dwconv_res1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.block3b_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3b_bn_res1/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.block3b_se_reduce_res1_convolution = self.__conv(2, name='block3b_se_reduce_res1/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3b_se_expand_res1_convolution = self.__conv(2, name='block3b_se_expand_res1/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3b_project_conv_res1_convolution = self.__conv(2, name='block3b_project_conv_res1/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3b_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3b_project_bn_res1/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.block3c_expand_conv_res1_convolution = self.__conv(2, name='block3c_expand_conv_res1/convolution', in_channels=56, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3c_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3c_expand_bn_res1/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.block3c_dwconv_res1_depthwise = self.__conv(2, name='block3c_dwconv_res1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.block3c_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3c_bn_res1/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.block3c_se_reduce_res1_convolution = self.__conv(2, name='block3c_se_reduce_res1/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3c_se_expand_res1_convolution = self.__conv(2, name='block3c_se_expand_res1/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3c_project_conv_res1_convolution = self.__conv(2, name='block3c_project_conv_res1/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3c_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3c_project_bn_res1/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.block3d_expand_conv_res1_convolution = self.__conv(2, name='block3d_expand_conv_res1/convolution', in_channels=56, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3d_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3d_expand_bn_res1/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.block3d_dwconv_res1_depthwise = self.__conv(2, name='block3d_dwconv_res1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.block3d_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3d_bn_res1/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.block3d_se_reduce_res1_convolution = self.__conv(2, name='block3d_se_reduce_res1/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3d_se_expand_res1_convolution = self.__conv(2, name='block3d_se_expand_res1/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.block3d_project_conv_res1_convolution = self.__conv(2, name='block3d_project_conv_res1/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.block3d_project_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'block3d_project_bn_res1/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv1_skeleton_conv1_convolution = self.__conv(2, name='pass1_block1_mbconv1_skeleton_conv1/convolution', in_channels=80, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv1_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv1_skeleton_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv1_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block1_mbconv1_skeleton_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass1_block1_mbconv1_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv1_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv1_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block1_mbconv1_skeleton_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv1_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block1_mbconv1_skeleton_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv1_skeleton_conv2_convolution = self.__conv(2, name='pass1_block1_mbconv1_skeleton_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv1_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv1_skeleton_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv2_skeleton_conv1_convolution = self.__conv(2, name='pass1_block1_mbconv2_skeleton_conv1/convolution', in_channels=56, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv2_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv2_skeleton_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv2_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block1_mbconv2_skeleton_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass1_block1_mbconv2_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv2_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv2_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block1_mbconv2_skeleton_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv2_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block1_mbconv2_skeleton_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv2_skeleton_conv2_convolution = self.__conv(2, name='pass1_block1_mbconv2_skeleton_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv2_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv2_skeleton_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv3_skeleton_conv1_convolution = self.__conv(2, name='pass1_block1_mbconv3_skeleton_conv1/convolution', in_channels=112, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv3_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv3_skeleton_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv3_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block1_mbconv3_skeleton_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass1_block1_mbconv3_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv3_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block1_mbconv3_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block1_mbconv3_skeleton_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv3_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block1_mbconv3_skeleton_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block1_mbconv3_skeleton_conv2_convolution = self.__conv(2, name='pass1_block1_mbconv3_skeleton_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block1_mbconv3_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block1_mbconv3_skeleton_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv1_skeleton_conv1_convolution = self.__conv(2, name='pass1_block2_mbconv1_skeleton_conv1/convolution', in_channels=168, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv1_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv1_skeleton_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv1_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block2_mbconv1_skeleton_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass1_block2_mbconv1_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv1_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv1_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block2_mbconv1_skeleton_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv1_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block2_mbconv1_skeleton_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv1_skeleton_conv2_convolution = self.__conv(2, name='pass1_block2_mbconv1_skeleton_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv1_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv1_skeleton_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv2_skeleton_conv1_convolution = self.__conv(2, name='pass1_block2_mbconv2_skeleton_conv1/convolution', in_channels=56, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv2_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv2_skeleton_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv2_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block2_mbconv2_skeleton_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass1_block2_mbconv2_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv2_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv2_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block2_mbconv2_skeleton_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv2_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block2_mbconv2_skeleton_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv2_skeleton_conv2_convolution = self.__conv(2, name='pass1_block2_mbconv2_skeleton_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv2_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv2_skeleton_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv3_skeleton_conv1_convolution = self.__conv(2, name='pass1_block2_mbconv3_skeleton_conv1/convolution', in_channels=112, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv3_skeleton_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv3_skeleton_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv3_skeleton_dconv1_depthwise = self.__conv(2, name='pass1_block2_mbconv3_skeleton_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass1_block2_mbconv3_skeleton_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv3_skeleton_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass1_block2_mbconv3_skeleton_se_se_squeeze_conv_convolution = self.__conv(2, name='pass1_block2_mbconv3_skeleton_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv3_skeleton_se_se_excite_conv_convolution = self.__conv(2, name='pass1_block2_mbconv3_skeleton_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass1_block2_mbconv3_skeleton_conv2_convolution = self.__conv(2, name='pass1_block2_mbconv3_skeleton_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass1_block2_mbconv3_skeleton_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass1_block2_mbconv3_skeleton_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv1_detection1_conv1_convolution = self.__conv(2, name='pass2_block1_mbconv1_detection1_conv1/convolution', in_channels=248, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv1_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv1_detection1_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv1_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block1_mbconv1_detection1_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass2_block1_mbconv1_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv1_detection1_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv1_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block1_mbconv1_detection1_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv1_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block1_mbconv1_detection1_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv1_detection1_conv2_convolution = self.__conv(2, name='pass2_block1_mbconv1_detection1_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv1_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv1_detection1_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv2_detection1_conv1_convolution = self.__conv(2, name='pass2_block1_mbconv2_detection1_conv1/convolution', in_channels=56, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv2_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv2_detection1_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv2_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block1_mbconv2_detection1_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass2_block1_mbconv2_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv2_detection1_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv2_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block1_mbconv2_detection1_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv2_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block1_mbconv2_detection1_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv2_detection1_conv2_convolution = self.__conv(2, name='pass2_block1_mbconv2_detection1_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv2_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv2_detection1_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv3_detection1_conv1_convolution = self.__conv(2, name='pass2_block1_mbconv3_detection1_conv1/convolution', in_channels=112, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv3_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv3_detection1_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv3_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block1_mbconv3_detection1_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass2_block1_mbconv3_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv3_detection1_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block1_mbconv3_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block1_mbconv3_detection1_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv3_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block1_mbconv3_detection1_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block1_mbconv3_detection1_conv2_convolution = self.__conv(2, name='pass2_block1_mbconv3_detection1_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block1_mbconv3_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block1_mbconv3_detection1_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv1_detection1_conv1_convolution = self.__conv(2, name='pass2_block2_mbconv1_detection1_conv1/convolution', in_channels=168, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv1_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv1_detection1_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv1_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block2_mbconv1_detection1_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass2_block2_mbconv1_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv1_detection1_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv1_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block2_mbconv1_detection1_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv1_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block2_mbconv1_detection1_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv1_detection1_conv2_convolution = self.__conv(2, name='pass2_block2_mbconv1_detection1_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv1_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv1_detection1_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv2_detection1_conv1_convolution = self.__conv(2, name='pass2_block2_mbconv2_detection1_conv1/convolution', in_channels=56, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv2_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv2_detection1_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv2_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block2_mbconv2_detection1_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass2_block2_mbconv2_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv2_detection1_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv2_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block2_mbconv2_detection1_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv2_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block2_mbconv2_detection1_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv2_detection1_conv2_convolution = self.__conv(2, name='pass2_block2_mbconv2_detection1_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv2_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv2_detection1_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv3_detection1_conv1_convolution = self.__conv(2, name='pass2_block2_mbconv3_detection1_conv1/convolution', in_channels=112, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv3_detection1_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv3_detection1_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv3_detection1_dconv1_depthwise = self.__conv(2, name='pass2_block2_mbconv3_detection1_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass2_block2_mbconv3_detection1_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv3_detection1_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass2_block2_mbconv3_detection1_se_se_squeeze_conv_convolution = self.__conv(2, name='pass2_block2_mbconv3_detection1_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv3_detection1_se_se_excite_conv_convolution = self.__conv(2, name='pass2_block2_mbconv3_detection1_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass2_block2_mbconv3_detection1_conv2_convolution = self.__conv(2, name='pass2_block2_mbconv3_detection1_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass2_block2_mbconv3_detection1_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass2_block2_mbconv3_detection1_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv1_detection2_conv1_convolution = self.__conv(2, name='pass3_block1_mbconv1_detection2_conv1/convolution', in_channels=248, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv1_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv1_detection2_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv1_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block1_mbconv1_detection2_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass3_block1_mbconv1_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv1_detection2_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv1_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block1_mbconv1_detection2_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv1_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block1_mbconv1_detection2_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv1_detection2_conv2_convolution = self.__conv(2, name='pass3_block1_mbconv1_detection2_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv1_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv1_detection2_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv2_detection2_conv1_convolution = self.__conv(2, name='pass3_block1_mbconv2_detection2_conv1/convolution', in_channels=56, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv2_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv2_detection2_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv2_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block1_mbconv2_detection2_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass3_block1_mbconv2_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv2_detection2_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv2_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block1_mbconv2_detection2_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv2_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block1_mbconv2_detection2_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv2_detection2_conv2_convolution = self.__conv(2, name='pass3_block1_mbconv2_detection2_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv2_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv2_detection2_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv3_detection2_conv1_convolution = self.__conv(2, name='pass3_block1_mbconv3_detection2_conv1/convolution', in_channels=112, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv3_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv3_detection2_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv3_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block1_mbconv3_detection2_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass3_block1_mbconv3_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv3_detection2_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block1_mbconv3_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block1_mbconv3_detection2_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv3_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block1_mbconv3_detection2_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block1_mbconv3_detection2_conv2_convolution = self.__conv(2, name='pass3_block1_mbconv3_detection2_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block1_mbconv3_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block1_mbconv3_detection2_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv1_detection2_conv1_convolution = self.__conv(2, name='pass3_block2_mbconv1_detection2_conv1/convolution', in_channels=168, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv1_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv1_detection2_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv1_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block2_mbconv1_detection2_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass3_block2_mbconv1_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv1_detection2_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv1_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block2_mbconv1_detection2_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv1_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block2_mbconv1_detection2_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv1_detection2_conv2_convolution = self.__conv(2, name='pass3_block2_mbconv1_detection2_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv1_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv1_detection2_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv2_detection2_conv1_convolution = self.__conv(2, name='pass3_block2_mbconv2_detection2_conv1/convolution', in_channels=56, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv2_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv2_detection2_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv2_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block2_mbconv2_detection2_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass3_block2_mbconv2_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv2_detection2_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv2_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block2_mbconv2_detection2_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv2_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block2_mbconv2_detection2_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv2_detection2_conv2_convolution = self.__conv(2, name='pass3_block2_mbconv2_detection2_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv2_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv2_detection2_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv3_detection2_conv1_convolution = self.__conv(2, name='pass3_block2_mbconv3_detection2_conv1/convolution', in_channels=112, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv3_detection2_conv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv3_detection2_conv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv3_detection2_dconv1_depthwise = self.__conv(2, name='pass3_block2_mbconv3_detection2_dconv1/depthwise', in_channels=336, out_channels=336, kernel_size=(5, 5), stride=(1, 1), groups=336, bias=None)
        self.pass3_block2_mbconv3_detection2_dconv1_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv3_detection2_dconv1_bn/FusedBatchNorm_1', num_features=336, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_block2_mbconv3_detection2_se_se_squeeze_conv_convolution = self.__conv(2, name='pass3_block2_mbconv3_detection2_se_se_squeeze_conv/convolution', in_channels=336, out_channels=14, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv3_detection2_se_se_excite_conv_convolution = self.__conv(2, name='pass3_block2_mbconv3_detection2_se_se_excite_conv/convolution', in_channels=14, out_channels=336, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
        self.pass3_block2_mbconv3_detection2_conv2_convolution = self.__conv(2, name='pass3_block2_mbconv3_detection2_conv2/convolution', in_channels=336, out_channels=56, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=None)
        self.pass3_block2_mbconv3_detection2_conv2_bn_FusedBatchNorm_1 = self.__batch_normalization(2, 'pass3_block2_mbconv3_detection2_conv2_bn/FusedBatchNorm_1', num_features=56, eps=0.0010000000474974513, momentum=0.0)
        self.pass3_detection2_confs_convolution = self.__conv(2, name='pass3_detection2_confs/convolution', in_channels=168, out_channels=16, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=True)
    ...
    def forward(self, x):
        ...
        block1a_se_reshape_res1_Reshape = torch.reshape(input = block1a_se_squeeze_res1_Mean, shape = (-1,48,1,1))#(-1,1,1,48))
        ...
        block1b_se_reshape_res1_Reshape = torch.reshape(input = block1b_se_squeeze_res1_Mean, shape = (-1,24,1,1))#(-1,1,1,24))
        ...
        block2a_se_reshape_res1_Reshape = torch.reshape(input = block2a_se_squeeze_res1_Mean, shape = (-1,144,1,1))#(-1,1,1,144))
        ...
        block2b_se_reshape_res1_Reshape = torch.reshape(input = block2b_se_squeeze_res1_Mean, shape = (-1,192,1,1))#(-1,1,1,192))
        ...
        block2c_se_reshape_res1_Reshape = torch.reshape(input = block2c_se_squeeze_res1_Mean, shape = (-1,192,1,1))#(-1,1,1,192))
        ...
        block2d_se_reshape_res1_Reshape = torch.reshape(input = block2d_se_squeeze_res1_Mean, shape = (-1,192,1,1))#(-1,1,1,192))
        ...
        block3a_expand_conv_res1_convolution = self.block3a_expand_conv_res1_convolution(block2d_add_res1_add)
        ...
        block3a_se_reshape_res1_Reshape = torch.reshape(input = block3a_se_squeeze_res1_Mean, shape = (-1,192,1,1))#(-1,1,1,192))
        ...
        block3b_se_reshape_res1_Reshape = torch.reshape(input = block3b_se_squeeze_res1_Mean, shape = (-1,336,1,1))#(-1,1,1,336))
        ...
        block3c_se_reshape_res1_Reshape = torch.reshape(input = block3c_se_squeeze_res1_Mean, shape = (-1,336,1,1))#(-1,1,1,336))
        ...
        block3d_se_reshape_res1_Reshape = torch.reshape(input = block3d_se_squeeze_res1_Mean, shape = (-1,336,1,1))#(-1,1,1,336))
        ...
        concatenate_1_concat = torch.cat((block3d_add_res1_add, block2b_project_bn_res2_FusedBatchNorm_1), 1)
        ...
        concatenate_2_concat = torch.cat((pass1_block2_skip_skeleton_add, block3d_add_res1_add, block2b_project_bn_res2_FusedBatchNorm_1), 1)
        ...
        concatenate_3_concat = torch.cat((pass2_block2_skip_detection1_add, block3d_add_res1_add, block2b_project_bn_res2_FusedBatchNorm_1), 1)
        ...
        pass3_detection2_confs_convolution = self.pass3_detection2_confs_convolution(pass3_block2_skip_detection2_add)
